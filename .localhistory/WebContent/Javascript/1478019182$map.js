...
function initMap() {
    ...
    var customControlDivMenu = document.createElement('div');
    var customControlMenu = new CustomControl(customControlDivMenu, map, 'yellow');
    ...
    map.controls[google.maps.ControlPosition.CENTER_LEFT].push(customControlDivMenu);
...
function CustomdivMenu(controlDiv, map, flag) {
    
        var controlUI = document.createElement('button');
        controlUI.className = "btn btn-primary";
        controlUI.dataFld = "collapse";
