...
function initMap() {
    ...
    map.controls[google.maps.ControlPosition.BOTTOM_CENTER].push(customControlDiv1);
    map.controls[google.maps.ControlPosition.BOTTOM_CENTER].push(customControlDiv2);
    map.controls[google.maps.ControlPosition.BOTTOM_CENTER].push(customControlDiv3);
    map.controls[google.maps.ControlPosition.BOTTOM_CENTER].push(customControlDiv4);
