...
public class ConflictCheck : System.Web.Services.WebService {
    ...
    public ArrayList CheckAppAreaForNotification(AppArea userapparea, user user)
    {
        // string retval = "false";
        string apppreference = user.preferences;
        
        float comparedistance = 0;
        ArrayList finalcroplist = new ArrayList();
    ...
    public ArrayList CheckApplicatorNotification(user appuser)
    {
        //ArrayList finallist = new ArrayList();
        ...
        ArrayList appareas = new ArrayList();
        ArrayList conflictareas = new ArrayList();
        ArrayList temp_conflictareas = new ArrayList();
