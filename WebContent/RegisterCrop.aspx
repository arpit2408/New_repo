                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-11 col-lg-offset-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="applicatorcolumns" style="display: none">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="panel panel-default">
                                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="pesticideName" name="areaPolygon" class="form-control" placeholder="Please enter pesticide name" required="required" readonly="readonly" />
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="submit" onclick="return SubmitNewLocation(event)" id="saveRegisterCrop" class="btn btn-primary btn-send" value="Save" />
                                    </div>
                                </div>
                            </div>
                        </div>
