...
s_a1[3] = "Amaranths|Artichokes|Asparagus|Beans|Beets|Broccoli|Brussels sprouts|Cabbage|Cantaloupes|Carrots|Cauliflower|Celeriac, celeryroot|Celery|Chickpeas|Chinese beans|Chinese cabbage|Chinese okra|Chinese radish|Cilantro|Collards|Cucumbers|Edible flowers|Edible podded peas|Edible soybeans|Eggplant|Escarole/Endive|Garlic|Ginger|Honeydew melons|Horseradish|Jerusalem artichoke|Jicama|Kale|Kohrirabi|Leeks|Lentils|Lettuce|Melons, specialty|Mushrooms|Mustard greens|Okra|Onions, dry|Onions,green|Parsley|Parsnip|Peas, Chinese-sugar|Peas, green|Peas, green southern, blackeyed, crowder, etc.|Peas, pigeon|Peppers, bell|Peppers, Jalapeno and other|Potatoes|Pumpkins|Radishes|Rhubarb|Rutabaga|Salisfy|Shallots|Spinach|Squash|Sweetcorn|Sweet potatoes|Taro|Tomatoes|Tomatillos|Turnips|Watermelons|Other|Fallow";
