...
function initMap() {
    ...
    var bs = document.getElementById('wrapperButton');
    ...
    map.controls[google.maps.ControlPosition.BOTTOM_CENTER].push(customSpaceDiv);
    //map.controls[google.maps.ControlPosition.LEFT].push(bs);
